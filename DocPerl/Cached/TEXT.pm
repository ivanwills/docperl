...
sub process {
	...
	my $out    = Pod::POM::View::HTML->print($pom);

	$out =~ s{<html>}{<html><link rel="stylesheet" href="?page=css.css" type="text/css" />}xms;
...
This documentation refers to DocPerl::Cached::TEXT version 0.1.
